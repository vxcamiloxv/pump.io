...
var makeApp = function(configBase, callback) {
    ...
    db.connect({}, function(err) {
        ...
        // i18n support
        var i18nNamespace = "messages";

        i18n.use(i18nMiddleware.LanguageDetector).use(i18nBackend).init({
            ...
            i18n.changeLanguage(config.defaultLang, function(err) {
                if (err) {
                    log.error(err);
                }
            });
        ...
        app.use(function(req, res, next) {
            ...
            res.locals.i18nResource = {
                ns: i18nNamespace,
                lng: i18n.language,
                resource: i18n.getResourceBundle(i18n.language) || {}
            };
